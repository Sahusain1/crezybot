...
API_ID = int(environ.get('API_ID', '13343808'))
API_HASH = environ.get('API_HASH', '088f42c6d0ae16537e258f8d5c898609')
BOT_TOKEN = environ.get('BOT_TOKEN', "6357980497:AAEwZC0YCOaIQDIwUd-mrTdb3HqemcxIH_8")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5879538132').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001806675173').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://afzalhusain:afzalhusain@cluster0.wrtoqoy.mongodb.net/?retryWrites=true&w=majority")
...
# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1001965858192'))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '-1001884534425'))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/+g7SA3YKDlgdjOTFl')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://youtu.be/sJ4fs5X60PI')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001971752892'))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', '-1001890457808'))
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', 'C3GRFOOXwYcgRK1Y5zdw9ih1C362')
